...
path = r"c:\Users\27vid\Downloads\Habit Engine\src\api\main.py"
content = r'''from fastapi import FastAPI, HTTPException
...
from src.domain.api_schemas import (
    EngineResponse, SimulationParams, TrainingResponse, DailyInput
)
